        ...
        <div style="width: 1250px" id="product-section">
            <div class="row">
                ...
                <div class="col-md-3 ">
                    ...
                    <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button Style="height: 50px; display: inline; right: 50%; width: 100%" class="btn btn-primary btn-lg btn-brand btn-full-width" ID="btnCheckout" runat="server" Text="Check Out"  />
                        &nbsp;
                    </p>
                </div>

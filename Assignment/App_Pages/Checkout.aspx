                ...
                <div class="col-md-8 ms-auto me-auto ">
                    ...
                    <p style="margin-left: 60px">
                        <table style="margin-left: 40px; width: 100%">
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row" style="width: 350px; font-size:13px">
                                        <asp:Label ID="lblRecipientName" class="col-5 col-form-label" runat="server">Recipient Name</asp:Label>
                                        <div class="col-7">
